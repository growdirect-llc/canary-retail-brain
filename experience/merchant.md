...
1. **Stays on track.** The platform notices drift. You react to surfaced exceptions, not to the chase of weekly reports.
2. **Meets your customers where they're going.** The platform's local market layer surfaces seasonality, weather, and community signals tuned to your store's geography. You see the demand shift before the competitor does.
3. **Operates above your weight class.** The agent network does the analytical work that would otherwise need a department.
4. **Gets back to running the store.** The hours you used to spend on operational reconciliation become hours on the floor. The customers you used to interrupt become the customers you serve.

You are a merchant again.

## Related

- [Why Canary](../why/why) — the rails and meter model that produce this experience
- [The store manager](store-manager) — the role one level operational from yours
- [Modules](../modules/modules) — what runs underneath the dashboard

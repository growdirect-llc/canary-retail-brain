...
- [The store manager](store-manager) — escalation source for store-level concerns
- [The merchant](merchant) — destination for shrink-rate trend reporting
- [The external party](external-party) — auditors and law enforcement consume the same chain you investigate against

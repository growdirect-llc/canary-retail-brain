...
- **Retailers who aren't ready to swap stacks** but suspect they're leaving money on the table.
- **CIOs preparing a transformation case** who need a third-party operational read.
- **Boards** looking for objective baseline metrics for a strategic review.
- **Lenders or insurers** requiring an operational health assessment as part of due diligence.
...
- [Transformation mode](transformation) — the natural next step when the audit surfaces enough opportunity
- [Why Canary](../why/why) — the framework the audit applies to the merchant's data
- [Proof](../proof/proof) — anonymized audit examples and outcome ranges

...
- [Why Canary](../why/why) — the three rails and meter model the transformation delivers
- [Operating system mode](operating-system) — the long-term resting state after transformation
- [Proof](../proof/proof) — worked examples and PwC benchmarks
